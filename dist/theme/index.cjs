...
__export(theme_exports, {
  CssBaseline: () => import_material.CssBaseline,
  ThemeProvider: () => import_material.ThemeProvider,
...
var spacing = 8;
var muiTheme = (0, import_styles.createTheme)({
  palette: {
    mode: "light",
    primary: {
      main: "#115A95",
...
var bgRadial2 = `radial-gradient(circle, ${(0, import_styles2.alpha)(secondary, 0.06)} 0%, transparent 70%)`;
